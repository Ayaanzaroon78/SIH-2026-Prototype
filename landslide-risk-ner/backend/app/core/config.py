...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite:///./landslide_dev.db")
    ...
    MODEL_DIR: str = os.getenv("MODEL_DIR", os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../ml/model_artifacts")))
